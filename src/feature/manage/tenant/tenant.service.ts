...
export class TenantService {
    ...
    async setTenantDomain(data: ISetTenantDomainRequest): Promise<IFullTenantProfileResponse> {
        try {
            ...
            //Find tenant owner of recent domain from caller
            ...
            if (tenantExistExternalService.tenant === undefined) {
                ...
                const createTenant =
                    await this.createTenantAdminService.createTenant(dataCreateTenant);
